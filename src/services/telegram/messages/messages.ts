...
Где 5 - это количество километров (необязательно).
`,
  lastStepsPromptMessage: `🏃‍♂️ Введите количество шагов, которые вы сделали за предыдущую неделю.

Используйте формат:
/laststeps [количество_шагов] [-[количество_километров]]
...
/laststeps - Запись шагов за предыдущую неделю
